// 第一次播放音乐
var luvicii_musicFirst = false;
// 快捷键
var luvicii_keyboard = null;
// 音乐播放状态
var luvicii_musicPlaying = false;
var $bodyWrap = document.getElementById("body-wrap");
var luvicii_intype = false;
var luvicii_keyUpEvent_timeoutId = null;
var luvicii_keyUpShiftDelayEvent_timeoutId = null;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const sidebarFn = {
    open: () => {
      luvicii.sidebarPaddingR();
      luvicii.animateIn(document.getElementById("menu-mask"), "to_show 0.5s");
    ...
    close: () => {
      ...
      luvicii.animateOut(document.getElementById("menu-mask"), "to_hide 0.5s");
  ...
  const scrollDownInIndex = () => {
    const handleScrollToDest = () => {
      ...
      if (bbTimeList) {
        luvicii.scrollToDest(bbTimeList.offsetTop - 62, 300);
      } else {
        luvicii.scrollToDest(document.getElementById("home_top").offsetTop - 60, 300);
      }
    };

    const $scrollDownEle = document.getElementById("scroll-down");
    $scrollDownEle && luvicii.addEventListenerPjax($scrollDownEle, "click", handleScrollToDest);
  };
  ...
  const addHighlightTool = function () {
    ...
    const highlightShrinkEle =
      isHighlightShrink !== undefined
        ? '<i class="luviciifont luvicii-icon-angle-down expand ${highlightShrinkClass}"></i>'
        : "";
    const highlightCopyEle = highlightCopy
      ? '<div class="copy-notice"></div><i class="luviciifont luvicii-icon-paste copy-button"></i>'
      : "";

    const alertInfo = (ele, text) => {
      if (GLOBAL_CONFIG.Snackbar !== undefined) {
        luvicii.snackbarShow(text);
      } else {
    ...
    const createEle = (lang, item, service) => {
      ...
      if (isShowTool) {
        ...
        luvicii.addEventListenerPjax(hlTools, "click", highlightToolsFn);
      ...
      if (highlightHeightLimit && item.offsetHeight > highlightHeightLimit + 30) {
        ...
        ele.innerHTML = '<i class="luviciifont luvicii-icon-angle-double-down"></i>';
        luvicii.addEventListenerPjax(ele, "click", expandCode);
    ...
    if (isPrismjs) {
      $figureHighlight.forEach(item => {
        if (highlightLang) {
          ...
          luvicii.wrap(item, "figure", { class: "highlight" });
   ...
   */
  const runLightbox = () => {
    luvicii.loadLightbox(document.querySelectorAll("#article-container img:not(.no-lightbox)"));
  };
  ...
  const runJustifiedGallery = function (ele) {
    ...
    const runJustifiedGallery = (item, arr) => {
      ...
      if (!item.classList.contains("lazyload") || arr.length < limit) {
        ...
        if (!item.classList.contains("btn_album_detail_lazyload") || item.classList.contains("page_img_lazyload")) {
          ...
          const clickBtnFn = () => {
            ...
            luvicii.loadLightbox(item.querySelectorAll("img"));
      ...
      luvicii.initJustifiedGallery(item);
      luvicii.loadLightbox(item.querySelectorAll("img"));
      window.lazyLoadInstance && window.lazyLoadInstance.update();
    };
  ...
  const scrollFn = function () {
    ...
    const scrollTask = luvicii.throttle(() => {
    ...
    scrollTask();
    luvicii.addEventListenerPjax(window, "scroll", scrollTask, { passive: true });
  };
  ...
  const scrollFnToDo = function () {
    ...
    if (isToc) {
      ...
      const tocItemClickFn = e => {
        ...
        e.preventDefault();
        luvicii.scrollToDest(
          luvicii.getEleTop(document.getElementById(decodeURI(target.getAttribute("href")).replace("#", ""))) - 60,
          300
        );
      ...
      luvicii.addEventListenerPjax($cardToc, "click", tocItemClickFn);
    ...
    const findHeadPosition = function (top) {
      ...
      filteredHeadings.forEach(function (ele, index) {
        if (top > luvicii.getEleTop(ele) - 80) {
          const id = ele.id;
      ...
      if (isAnchor) luvicii.updateAnchor(currentId);
    ...
    // main of scroll
    const tocScrollFn = luvicii.throttle(() => {
      const currentTop = window.scrollY || document.documentElement.scrollTop;
      findHeadPosition(currentTop);
    }, 100);

    luvicii.addEventListenerPjax(window, "scroll", tocScrollFn, { passive: true });
  };
  ...
  const handleThemeChange = mode => {
    ...
    if (!GLOBAL_CONFIG_SITE.isPost) {
      ...
      root.style.setProperty("--luvicii-bar-background", "var(--luvicii-meta-theme-color)");
      requestAnimationFrame(() => {
        luvicii.initThemeColor();
      });
      ...
      document.documentElement.style.setProperty(
        "--luvicii-main",
        getComputedStyle(document.documentElement).getPropertyValue("--luvicii-theme")
      );
      document.documentElement.style.setProperty(
        "--luvicii-theme-op",
        getComputedStyle(document.documentElement).getPropertyValue("--luvicii-main") + "23"
      );
      document.documentElement.style.setProperty(
        "--luvicii-theme-op-deep",
        getComputedStyle(document.documentElement).getPropertyValue("--luvicii-main") + "dd"
      );
    }
  };
  ...
  const rightSideFn = {
    readmode: () => {
      ...
      newEle.type = "button";
      newEle.className = "luviciifont luvicii-icon-xmark exit-readmode";
    ...
    darkmode: () => {
      ...
      if (willChangeMode === "dark") {
        activateDarkMode();
        GLOBAL_CONFIG.Snackbar !== undefined && luvicii.snackbarShow(GLOBAL_CONFIG.Snackbar.day_to_night);
      } else {
        activateLightMode();
        GLOBAL_CONFIG.Snackbar !== undefined && luvicii.snackbarShow(GLOBAL_CONFIG.Snackbar.night_to_day);
      }
  ...
  const openMobileMenu = () => {
    ...
    luvicii.addEventListenerPjax(document.getElementById("toggle-menu"), "click", handleClick);
  };
  ...
  const addCopyright = () => {
    ...
    const handleCopy = e => {
      if (copy) {
        luvicii.snackbarShow(languages.copySuccess);
      }
      if (copyrightEbable) {
        e.preventDefault();
  ...
  const addRuntime = () => {
    ...
    if ($runtimeCount) {
      ...
      $runtimeCount.textContent = `${luvicii.diffDate(publishDate)} ${GLOBAL_CONFIG.runtime}`;
    }
  };
  ...
  const addLastPushDate = () => {
    ...
    if ($lastPushDateItem) {
      ...
      $lastPushDateItem.textContent = luvicii.diffDate(lastPushDate, true);
    }
  };
  ...
  const addTableWrap = () => {
    ...
    $table.forEach(item => {
      if (!item.closest(".highlight")) {
        luvicii.wrap(item, "div", { class: "table-wrap" });
      }
    });
  };
  ...
  const tabsFn = () => {
      ...
      const navClickHandler = function (e) {
        ...
        if (isJustifiedGallery) {
          ...
          if ($isTabJustifiedGallery.length > 0) {
            luvicii.initJustifiedGallery($isTabJustifiedGallery);
          }
        }
      };
      luvicii.addEventListenerPjax(item.firstElementChild, "click", navClickHandler);
    };
    ...
    const addTabToTopEventListener = item => {
      const btnClickHandler = e => {
        const target = e.target.closest("button");
        if (!target) return;
        luvicii.scrollToDest(luvicii.getEleTop(item), 300);
      };
      luvicii.addEventListenerPjax(item.lastElementChild, "click", btnClickHandler);
    };
  ...
  const toggleCardCategory = () => {
    ...
    luvicii.addEventListenerPjax(cardCategory, "click", handleToggleBtn, true);
  };
  ...
  const switchComments = () => {
    ...
    luvicii.addEventListenerPjax(switchBtn, "click", handleSwitchBtn);
  };

  const addPostOutdateNotice = function () {
    const data = GLOBAL_CONFIG.noticeOutdate;
    const diffDay = luvicii.diffDate(GLOBAL_CONFIG_SITE.postUpdate);
  ...
  const relativeDate = function (selector) {
    selector.forEach(item => {
      ...
      item.textContent = luvicii.diffDate(timeVal, true);
  ...
  const coverColor = async () => {
    ...
    if (GLOBAL_CONFIG.mainTone) {
      if (GLOBAL_CONFIG_SITE.postMainColor) {
        ...
        root.style.setProperty("--luvicii-bar-background", value);
        requestAnimationFrame(() => {
          luvicii.initThemeColor();
        });

        if (GLOBAL_CONFIG.mainTone.cover_change) {
          document.documentElement.style.setProperty("--luvicii-main", value);
          document.documentElement.style.setProperty(
            "--luvicii-theme-op",
            getComputedStyle(document.documentElement).getPropertyValue("--luvicii-main") + "23"
          );
        ...
        const fallbackValue = "var(--luvicii-theme)";
        let fetchPath = "";
            ...
            if (GLOBAL_CONFIG.mainTone.mode == "both") {
              ...
              try {
                ...
                if (response.ok && response.headers.get("content-type")?.includes("application/json")) {
                  ...
                  root.style.setProperty("--luvicii-bar-background", fallbackValue);
                  requestAnimationFrame(() => {
                    luvicii.initThemeColor();
                  });
                  document.documentElement.style.setProperty("--luvicii-main", fallbackValue);
                }
              } catch {
                root.style.setProperty("--luvicii-bar-background", fallbackValue);
                requestAnimationFrame(() => {
  ...
  window.onkeydown = function (e) {
    123 === e.keyCode && luvicii.snackbarShow("开发者模式已打开，请遵循GPL协议", !1);
  };
  ...
  function executeShortcutKeyFunction() {
    // 是否开启快捷键
    luvicii_keyboard = localStorage.getItem("keyboardToggle") ? localStorage.getItem("keyboardToggle") : false;
    ...
    function keyDownEvent(event) {
      ...
      const isKeyboardEnabled = luvicii_keyboard;
      const isInInputField = luvicii_intype;
      ...
      if (isKeyboardEnabled && isShiftKeyPressed && !isInInputField) {
        luvicii_keyUpShiftDelayEvent_timeoutId = setTimeout(() => {
          switch (event.keyCode) {
            case 16:
              luvicii_keyUpEvent_timeoutId = setTimeout(() => {
                document.querySelector("#keyboard-tips").classList.add("show");
              }, shortcutKeyShiftDelay);
              break;
            case 65:
              luvicii.switchConsole();
              break;
            case 77:
              luvicii.musicToggle();
              break;
            case 75:
              luvicii.keyboardToggle();
              break;
            case 73:
              luvicii.rightMenuToggle();
              break;
            case 82:
              toRandomPost();
              break;
    ...
    function keyUpEvent(event) {
      luvicii_keyUpEvent_timeoutId && clearTimeout(luvicii_keyUpEvent_timeoutId);
      luvicii_keyUpShiftDelayEvent_timeoutId && clearTimeout(luvicii_keyUpShiftDelayEvent_timeoutId);
      if (event.keyCode === 16) {
  ...
  const unRefreshFn = function () {
    window.addEventListener("resize", () => {
      adjustMenu(false);
      mobileSidebarOpen && luvicii.isHidden(document.getElementById("toggle-menu")) && sidebarFn.close();
    });
  ...
  window.refreshFn = function () {
    ...
    luvicii.initIndexEssay();
    luvicii.changeTimeInEssay();
    ...
    luvicii.addNavBackgroundInit();
    luvicii.setValueToBodyType();
    luvicii.catalogActive();
    luvicii.tagsPageActive();
    luvicii.categoriesBarActive();
    luvicii.topCategoriesBarScroll();
    luvicii.switchRightClickMenuHotReview();
