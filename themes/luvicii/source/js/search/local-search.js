window.addEventListener("load", () => {
  ...
  const openSearch = () => {
    ...
    luvicii.animateIn(document.querySelector("#local-search .search-dialog"), "titleScale 0.5s");
    setTimeout(() => {
  ...
  const closeSearch = () => {
    ...
    bodyStyle.width = "";
    bodyStyle.overflow = "";
    luvicii.animateOut(document.querySelector("#local-search .search-dialog"), "search_close .5s");
  ...
  const search = () => {
    ...
    $input.addEventListener("input", function () {
      ...
      if (keywords[0] !== "")
        $loadingStatus.innerHTML = '<i class="luviciifont luvicii-icon-spinner luvicii-pulse-icon"></i>';
