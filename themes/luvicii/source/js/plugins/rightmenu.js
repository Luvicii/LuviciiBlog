...
function addRightMenuClickEvent() {
  ...
  $("#menu-commentBarrage").on("click", luvicii.switchCommentBarrage);
  ...
  //音乐
  $("#menu-music-toggle").on("click", luvicii.musicToggle);
  $("#menu-music-back").on("click", luvicii.musicSkipBack);
  $("#menu-music-forward").on("click", luvicii.musicSkipForward);
