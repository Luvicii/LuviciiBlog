(function () {
  ...
  const aiTitleRefreshIcon = post_ai.querySelector(".ai-title .luviciifont.luvicii-icon-arrow-rotate-right");
  let aiReadAloudIcon = post_ai.querySelector(".luvicii-icon-circle-dot");
  ...
  async function readAloud() {
    if (!summaryID) {
      luvicii.snackbarShow("摘要还没加载完呢，请稍后。。。");
      return;
    }
    aiReadAloudIcon = post_ai.querySelector(".luvicii-icon-circle-dot");
